...
if ( is_multisite() ) {
	...
	foreach ( $blogs as $idb ) {
		...
		// Update.
		update_blog_option( $idb, 'spam_master_upgrade_to_7_3_1', '1' );
		update_blog_option( $idb, 'spam_master_db_version', '731' );
	}
} else {
	// Update DB.
	...
	// Update.
	update_option( 'spam_master_upgrade_to_7_3_1', '1' );
	update_option( 'spam_master_db_version', '731' );
}
...
$spamtype                   = 'Upgraded';
$spamvalue                  = 'Plugin Install or Upgrade Tasks Done 7_3_1.';
$cache                      = '4H';
